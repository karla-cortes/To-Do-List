...
class NamEsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { [field[: @name.[field[, [options]: @name.[options], field[: @name.field[ } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { [field[: @name.[field[, [options]: @name.[options], field[: @name.field[ } }
